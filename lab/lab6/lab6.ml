...
{ begin
  ...
  ...code du "main" (bloc principal)...
   ...
   (i) Énumérez toutes les variables visibles dans le corps de f,
       ...
       le corps de f voit x,a,y(f),z(f)

   (ii) Faites de même pour la fonction g.
        le corps de g voit y,z,a,x(g),w
        
   (iii) Faites de même pour la fonction h.
        le corps de h voit y,x(g),a(h),b,w(g),z(h)
   ...
   let f (u : int) = 
    ...
    let y = 4 in
    let z = 5 in 
      print_string "variables f:";print_newline ();
      print_string "u = "; print_int u;
      print_newline ();
      print_string "a = ";print_int a;
      print_newline();
      print_string "x = ";print_int x;
      print_newline();
      print_string "y = ";print_int y;
      print_newline();
      print_string "z = "; print_int z;;
   ...
   let g (u:int)=
    ...
    let h (v:int) =  
      ...
      let z = 11  in 
      print_newline ();
      print_string "variables h:";print_newline ();
      ...
      print_string "w = "; print_int w;
          in h u;
          print_newline ();
          print_string "variables g:";print_newline ();
          print_string "u = "; print_int u;
          print_newline ();
          print_string "a = ";print_int a;
          print_newline();
